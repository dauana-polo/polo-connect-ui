...
Nenhuma tabela, política, função, storage ou dado foi alterado. Campos de interveniente, testemunha, faturador, anexos e atividades operacionais exibidos no dossiê pós-venda são apenas demonstrativos.